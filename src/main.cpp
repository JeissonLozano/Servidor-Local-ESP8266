...
void setup() {
 ...
 //salida 
  ...
  String vatioshora = "IoT/VH"; 
  vatioshora.toCharArray(VATIOSHORA, 50);
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////    
    ...
    Serial.println("Enviando: [" +  String(VOLTAJE) + "] " + strVOLTAJE);
    client.publish(VOLTAJE, valueStr);
    
    strCORRIENTE = String((float)A);
    strCORRIENTE.toCharArray(valueStr, 15);
    Serial.println("Enviando: [" +  String(CORRIENTE) + "] " + strCORRIENTE);
    client.publish(CORRIENTE, valueStr);
    
    strPOTENCIA = String((float)P);
    strPOTENCIA.toCharArray(valueStr, 15);
    Serial.println("Enviando: [" +  String(POTENCIA) + "] " + strPOTENCIA);
    client.publish(POTENCIA, valueStr);
   
    strVATIOSHORA= String((float)VH);
    strVATIOSHORA.toCharArray(valueStr, 15);
    Serial.println("Enviando: [" +  String(VATIOSHORA) + "] " + strVATIOSHORA);
    client.publish(VATIOSHORA, valueStr);
